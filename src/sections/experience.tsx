          ...
          <div className="space-y-12">
            {experiences.map((exp, idx) => (
              ...
              >
                ...
                <div className="absolute left-[-5px] md:left-1/2 md:-translate-x-1/2 top-1 w-[10px] h-[10px] rounded-full bg-background border-2 border-primary" />
                <div className={`flex-1 pl-6 md:pl-0 ${idx % 2 === 0 ? "md:text-right" : ""}`}>
